...
@section ('contenido')
	{!!Form::open(['route'=>'informe-gerencial', 'method' => 'GET', 'role' => 'search'])!!}
		...
		{!!Form::submit('Buscar',['class'=>'btn btn-primary', 'id' => ''])!!}
	{!!Form::close()!!}
	@php
		...
		<div class="row">
			...
			<div class="col-md-6" id="box5">
					...
					<div class="box box-primary">
						...
						<div class="box-body">
							<div class="chart">
								<canvas id="Chartvar31" width="200" height="200"></canvas> 
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-md-6" id="box5">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title" style="font-size:17px;">(Consumo de alimento g/dia)</h3>
						<div class="box-tools pull-right">
							<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
						</div>
					</div>
					<div class="box-body">
						<div class="chart">
							<canvas id="Chartvar32" width="200" height="200"></canvas> 
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6" id="box5">
					...
					<div class="box box-primary">
						...
						<div class="box-body">
							<div class="chart">
								<canvas id="Chartvar35" width="200" height="200"></canvas> 
							</div>
						</div>
					</div>
				</div>
	...
	<script>
		...
		*/
		...
		$IsacTotal = EstudioGalponResultados::select(
					'estudio_galpon_resultados.lote','estudio_galpones.fk_estudio_id', 
					'estudio_galpones.individuos_semanas','empresa_granja_galpones.galpon_nombre'/*esto es lo que copias*/,
	        ...
	        $var28 = EstudioGalponResultados::select(
					...
					'estudio_galpones.fk_estudio_id','estudio_galpones.individuos_semanas', 'estudio_galpon_resultados.resultado','empresa_granja_galpones.galpon_nombre'
				)
				->join('estudio_galpones','estudio_galpon_resultados.fk_estudio_galpon_id','estudio_galpones.estudio_galpon_id')
	            ...
	            //graphic 31
	        $var31 = EstudioGalponResultados::select(
					'variables.variable_id',  'variables.variable_nombre','estudio_galpon_resultados.lote',
					'estudio_galpones.fk_estudio_id','estudio_galpones.individuos_semanas', 'estudio_galpon_resultados.resultado','empresa_granja_galpones.galpon_nombre'
				)
				->join('estudio_galpones','estudio_galpon_resultados.fk_estudio_galpon_id','estudio_galpones.estudio_galpon_id')
	            ...
	            ->where([
					...
					//'estudio_galpon_resultados.fk_galpone_id' => $galpon,
					'estudio_galpon_resultados.lote' => $lote ,
					'variables.variable_id' => 31 //aca va el id de la variable
	            ])
	            ->groupBy('variables.variable_id')
	            ->groupBy('estudio_galpon_resultados.fk_estudio_galpon_id')
	            ->get();
	            ...
	            //graphic 32
	        $var32 = EstudioGalponResultados::select(
					'variables.variable_id',  'variables.variable_nombre','estudio_galpon_resultados.lote',
					'estudio_galpones.fk_estudio_id','estudio_galpones.individuos_semanas', 'estudio_galpon_resultados.resultado','empresa_granja_galpones.galpon_nombre'
				)
				->join('estudio_galpones','estudio_galpon_resultados.fk_estudio_galpon_id','estudio_galpones.estudio_galpon_id')
	            ...
	            ->where([
					...
					//'estudio_galpon_resultados.fk_galpone_id' => $galpon,
					'estudio_galpon_resultados.lote' => $lote ,
					'variables.variable_id' => 32 //aca va el id de la variable
	            ])
	            ->groupBy('variables.variable_id')
	            ->groupBy('estudio_galpon_resultados.fk_estudio_galpon_id')
	            ->get();
	            ...
	            //graphic 28
	        $var35 = EstudioGalponResultados::select(
					'variables.variable_id',  'variables.variable_nombre','estudio_galpon_resultados.lote',
					'estudio_galpones.fk_estudio_id','estudio_galpones.individuos_semanas', 'estudio_galpon_resultados.resultado','empresa_granja_galpones.galpon_nombre'
				)
				->join('estudio_galpones','estudio_galpon_resultados.fk_estudio_galpon_id','estudio_galpones.estudio_galpon_id')
	            ...
	            ->where([
					...
					//'estudio_galpon_resultados.fk_galpone_id' => $galpon,
					'estudio_galpon_resultados.lote' => $lote ,
					'variables.variable_id' => 35 //aca va el id de la variable
	            ])
	            ->groupBy('variables.variable_id')
	            ->groupBy('estudio_galpon_resultados.fk_estudio_galpon_id')
	            ->get();
			...
			$variable3= EstudioGalponResultados::select(
					'variables.variable_id',  'variables.variable_nombre','estudio_galpon_resultados.lote',
					'estudio_galpones.fk_estudio_id','estudio_galpones.individuos_semanas','empresa_granja_galpones.galpon_nombre', \DB::raw('100*estudio_galpon_resultados.porcentaje_afectacion as porcentaje_afectacion')
				)
				->join('estudio_galpones','estudio_galpon_resultados.fk_estudio_galpon_id','estudio_galpones.estudio_galpon_id')
				->join('variables','estudio_galpon_resultados.fk_variable_id','variables.variable_id')
				->join('empresa_granja_galpones','estudio_galpones.fk_galpone_id','empresa_granja_galpones.galpone_id')
		...
		@if($visible)
          ...
          var ctx = document.getElementById("Chartvar27").getContext('2d');
			...
			//%POSTURA
			var ctx = document.getElementById("Chartvar31").getContext('2d');
			data = {
			    datasets: [
			     	{
		                label: "% Postura",
			...
			//CONSUMO ALIMENTO
			var ctx = document.getElementById("Chartvar32").getContext('2d');
			data = {
			    datasets: [
			     	{
		                label: "Consumo",
			...
			// HUEVOS
			var ctx = document.getElementById("Chartvar35").getContext('2d');
			data = {
			    datasets: [
			     	{
